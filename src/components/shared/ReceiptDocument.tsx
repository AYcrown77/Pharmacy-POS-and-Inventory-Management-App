...
export function ReceiptDocument({
  ...
  return (
    <div
      ...
      className="pointer-events-none fixed left-[-200vw] top-0 w-[80mm] bg-white p-3 font-sans text-[11px] leading-[1.5] tabular-nums text-black"
    >
      ...
      <footer className="text-center">
        <p className="font-bold">Your Health, Our Priority</p>
        <p>{settings?.receiptFooter ?? "Thank you for your patronage."}</p>
      </footer>
    </div>
  );
}
